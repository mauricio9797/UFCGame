...
function preload() {
  ...
  for (i = 0; i < 3; i++) {
    item[i] = loadImage(`./Belts/B-${i}.png`);
    
  }
  for (i= 0; i < 15; i++) {
    adv[i] = loadImage(`./Adversaries/Adv-${i}.png`);
  }
  playerJon = loadImage("./images/jon.png");
  winImage = loadImage("./images/jonHallofFame.png");
  loseImage = loadImage("./images/jonJonesArrested.jpg");
  ...
  background1 = loadImage("./images/octufc.png");
  background2 = loadImage("./images/police.control.jpg");
  background3 = loadImage("./images/penitentiary.jpg");
}
